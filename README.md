...
def exponent_menu():
  print_header("EXPONENTIAL AND LOGARITHMS FUNCTIONS")
  print("""
...
(natural log, base e)")
     ...
     try:
       ...
       print(" Invalid input for a logarithms with that base. ")
...
def general_menu():
    ...
    3. Compute the hypotenouse of a right triangle
    0. Back to Main Menu
    """)
    choice = safe_input("Enter your choice: ").strip()
    ...
    if choice == "1":
        ...
        print(" factorial() requires a non negative integers. ")
